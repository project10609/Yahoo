...
class YahooeyeshadowSpider(scrapy.Spider):
    name = 'yahooeyeshadow'
    start_urls = ['https://tw.bid.yahoo.com/tw/%E7%9C%BC%E5%BD%B1-%E7%9C%BC%E9%83%A8%E5%BD%A9%E5%A6%9D-44380-category.html?.r=1586239909/']
    ...
    def parse(self, response):
        ...
        # self.action.pause(3)
        # self.action.perform()
        next_page = 'https://tw.bid.yahoo.com/tw/%E7%9C%BC%E5%BD%B1-%E7%9C%BC%E9%83%A8%E5%BD%A9%E5%A6%9D-44380-category.html?.r=1586239909&hpp=hp_category_2092073302&pg=' + str(
            YahooeyeshadowSpider.page)
        if YahooeyeshadowSpider.page <= 100:
            YahooeyeshadowSpider.page += 1
            url = next_page
