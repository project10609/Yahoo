...
class YahoolipstickSpider(scrapy.Spider):
    name = 'yahoolipstick'

    start_urls = ['https://tw.bid.yahoo.com/tw/%E5%94%87%E9%83%A8%E5%BD%A9%E5%A6%9D-2092078664-category.html?.r=1583292469&hpp=hp_category_2092073302']
    ...
    def parse(self, response):
        ...
        # self.action.pause(3)
        # self.action.perform()
        next_page = 'https://tw.bid.yahoo.com/tw/%E5%94%87%E9%83%A8%E5%BD%A9%E5%A6%9D-2092078664-category.html?.r=1583292469&hpp=hp_category_2092073302&pg=' + str(
            YahoolipstickSpider.page)
        if YahoolipstickSpider.page <= 100:
            YahoolipstickSpider.page += 1
            url = next_page
