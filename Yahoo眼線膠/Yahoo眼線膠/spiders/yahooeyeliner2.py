...
class Yahooeyeliner2Spider(scrapy.Spider):
    name = 'yahooeyeliner2'
    start_urls = ['https://tw.bid.yahoo.com/tw/%E7%9C%BC%E7%B7%9A%E8%86%A0-%E7%9C%BC%E9%83%A8%E5%BD%A9%E5%A6%9D-2092107632-category.html?.r=1586239909/']
    ...
    def parse(self, response):
        ...
        # self.action.pause(3)
        # self.action.perform()
        next_page = 'https://tw.bid.yahoo.com/tw/%E7%9C%BC%E7%B7%9A%E8%86%A0-%E7%9C%BC%E9%83%A8%E5%BD%A9%E5%A6%9D-2092107632-category.html?.r=1586239909&hpp=hp_category_2092073302&pg=' + str(
            Yahooeyeliner2Spider.page)
        if Yahooeyeliner2Spider.page <= 100:
            Yahooeyeliner2Spider.page += 1
            url = next_page
